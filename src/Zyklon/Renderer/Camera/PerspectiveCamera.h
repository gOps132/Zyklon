 ...
 * 	// Recommended defaults based on common usage:
 ...
 projection matrix rarely changes it's often best practice to set it outside the
 main loop only once. projection = glm::perspective(fovY, aspectRatio,
 nearPlane, farPlane);
*/

class PerspectiveCamera : public Camera {
public:
	PerspectiveCamera(float p_fovy, float p_aspect_ratio, float p_near_plane,
					  float p_far_plane);
